...
//返回聊天室id
    ...
    async getinitList(){
      wx.request({
         url: app.host +　'/chatMessage/getlist',
         method: 'GET',
      data: {        
        roomId: '1664248528504885249',
        },
        success: function (res) {
          app.initList = res.data;
        }
      })
    },
    ...
    async initRoom() {
      ...
      //  this.data.initList = 
        ...
        //  console.log('init1',this.getinitList())
          // const initList = await this.getinitList()
    ...
    async onConfirmSendText(e) {
      this.try(async () => {
        ...
        // await db.collection(collection).add({
          //String openid, String roomId,String msgType,String textContent
          wx.request({
             url: app.host +　'/chatMessage/add',
             method: 'GET',
          data: {        
