...
Page({
                ...
                success(e) {
                      that.setData({
                           // creatTime: config.formTime(e.data.creat),
                            ...
                            //detail: e.data => detail: e.data.list
                            //BUG 详情页获取不到图片
                            detail: e.data[0],
                            creatTime: e.data[0].creat,
                      })
                      that.getSeller(e.data.seller);
                },
                fail() {
      ...
      getSeller(m) {
            ...
             wx.request({
                ...
                                                data: {
                                                 //BUG 获取不到openid
                //                                  openid: this.data.detail.buyerInfo._openid, 
                                                     openid: this.data.detail.seller,
                                                },
                  success: function (res) {
                        wx.hideLoading();
                        that.setData({
